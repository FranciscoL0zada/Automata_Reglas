...
function wd = decoder_R167_Circular_list(we)
...
for l = 1 : length(we)
    ...
    if (Wtemp_(i1:i2)==a(1,:)) wd(l) = 1; end
    if (Wtemp_(i1:i2)==b(1,:)) wd(l) = 0; end
    if (Wtemp_(i1:i2)==c(1,:)) wd(l) = 1; end
    if (Wtemp_(i1:i2)==d(1,:)) wd(l) = 0; end
    if (Wtemp_(i1:i2)==e(1,:)) wd(l) = 0; end
    if (Wtemp_(i1:i2)==f(1,:)) wd(l) = 1; end
    if (Wtemp_(i1:i2)==g(1,:)) wd(l) = 1; end
